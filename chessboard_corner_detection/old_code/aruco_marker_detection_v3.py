...
"""
		...
		can return the 2D pixel locations in the following formats:
			...
			- (4x4x2) Matrix of 2D coordinates of aruco marker corners, A.
			- (16x2) Matrix of 2D coordinates of aruco marker corners, aruco_image_points.
		...
		* Format of aruco_image_points is described by diagram 4 bellow.
		...
		The corner locations can be stored in a (4x4x2) numpy array, A.
		...
		The corner locations can be stored in a (16x2) numpy array, A.
		...
		[ [m00_x, m00_y], ..., [m03_x, m03_y], ... , [m30_x, m30_y], ..., [m33_x, m33_y] ]
...
def detect_aruco_image_points(image, aruco_dict=None):
	...
	# reshape 4x4x2 matrix A to 16x2 aruco_image_points
	A = detect_A(image, aruco_dict)
	aruco_image_points = A.reshape(16,2)
