...
settings_dict = {
	"aruco_markers_settings_fname" : aruco_markers_settings_fname,
...
def write_settings_file(settings_dict):
	...
	# retreive file name
	aruco_markers_settings_fname = settings_dict["aruco_markers_settings_fname"]

	# logger
	logger.info("Writing aruco marker settings file (json file) too \"%s\"" % aruco_markers_settings_fname)

	# write json file
	with open(aruco_markers_settings_fname, 'w') as outfile:
